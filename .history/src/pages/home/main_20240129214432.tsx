...
export default function Home() {
    return (
        <Container style={{ margin: 0, padding: 0 }}>
            <Grid container display="flex" justifyContent="space-between" alignItems="center" style={{ height: '100vh', margin: 0 }}>
                ...
                <Grid container item direction="row" alignItems="center" md={4} style={{ margin: 0, background: '#f0f0f0', height: '100vh', width: '100%', padding: '0 16px' }}>
